      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-4xl mx-auto mb-24">
          ...
          >
            ...
            <span className="text-sm font-medium text-white/80 tracking-wide uppercase">Flexible Deployment</span>
          </motion.div>
          ...
          >
            Maja shows up <br className="hidden md:block" /> where your customers are.
          </motion.h2>
          ...
          >
            No phone trees. No friction. Just fast, text-based AI conversations in the channels your audience already uses.
          </motion.p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          <SpotlightCard delay={0.3} shouldReduceMotion={shouldReduceMotion}>
            <div className="mb-10">
              ...
              <h3 className="text-3xl font-bold text-white mb-4 group-hover:text-[#FF5D00] transition-colors duration-300">Embedded on your website</h3>
              <p className="text-white/60 text-lg leading-relaxed">
                Add Maja as an elegant AI front desk widget. She is always available, always on-brand, and never interrupts your design.
              </p>
            </div>
            ...
            <div className="mt-auto relative rounded-t-2xl bg-[#0A0A0A] border border-white/10 border-b-0 h-[300px] overflow-hidden shadow-2xl transition-all duration-500 group-hover:shadow-[0_-20px_60px_-15px_rgba(255,93,0,0.15)]">
              ...
              <motion.div className="absolute bottom-6 right-6 z-20" whileHover={{ scale: 1.05 }}>
          ...
          <SpotlightCard delay={0.4} shouldReduceMotion={shouldReduceMotion}>
            <div className="mb-10">
              ...
              <h3 className="text-3xl font-bold text-white mb-4 group-hover:text-purple-400 transition-colors duration-300">One chat link for all channels</h3>
              <p className="text-white/60 text-lg leading-relaxed">
                Turn social media into a pipeline. Share one smart link and let prospects chat with Maja from Instagram, LinkedIn, or email.
              </p>
            </div>
            ...
            <div className="mt-auto relative mx-auto w-[280px] rounded-t-[2.5rem] bg-[#0A0A0A] border border-white/10 border-b-0 h-[300px] overflow-hidden shadow-2xl transition-all duration-500 group-hover:shadow-[0_-20px_60px_-15px_rgba(168,85,247,0.15)]">
              ...
              <div className="p-6 flex flex-col items-center">
                ...
                >
                  ...
                  <span className="font-semibold text-white tracking-wide">Link in bio</span>
                  <div className="w-8 h-8 flex items-center justify-center">
                    <LinkIcon size={16} className="text-white/40" />
                  </div>
                </motion.div>
                <div className="mt-3 text-[10px] text-white/20 uppercase tracking-widest font-bold">Maja AI Link</div>
              </div>
            </div>
          </SpotlightCard>
        </div>
    ...
    >
      {!shouldReduceMotion && (
        <motion.div
          ...
          style={{ background: orangeSpotlight }}
        />
      )}
      {!shouldReduceMotion && (
        <motion.div
          className="pointer-events-none absolute -inset-px rounded-[2.5rem] opacity-0 transition duration-300 group-hover:opacity-100"
          style={{ background: whiteSpotlight }}
        />
      )}

      <div className="relative z-10 h-full flex flex-col p-8 md:p-12">{children}</div>
    </motion.div>
  )
}
