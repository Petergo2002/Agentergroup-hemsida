      ...
      <div className="relative w-full bg-[#0F0F0F] rounded-2xl border border-white/10 shadow-2xl overflow-hidden flex flex-col min-h-[420px]">
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/5 bg-[#141414]">
          <div className="flex items-center gap-3">
            ...
            <span className="font-medium text-white/90">Integrations</span>
          </div>
        ...
        <div className="p-8 flex-1 relative min-h-[400px]">
          ...
          <div className="mb-8 relative z-10">
            <h3 className="text-xl font-semibold text-white mb-2">Connect your tools</h3>
            <p className="text-white/40 text-sm">Automate your workflows by connecting Maja to your stack.</p>
          </div>
              ...
              >
                <div className="w-full max-w-md bg-[#1A1A1A] rounded-xl border border-white/10 shadow-2xl overflow-hidden flex flex-col">
                  <div className="px-6 py-4 border-b border-white/5 flex justify-between items-center">
                    <span className="text-white font-medium">Add integration</span>
                    ...
                    {apps.map((app) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {isSelected && (
                            <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} className="absolute top-1 right-1 w-4 h-4 bg-[#FF5D00] rounded-full flex items-center justify-center">
                  ...
                  <div className="px-6 py-4 border-t border-white/5 bg-[#141414] flex justify-end">
                    <motion.button
                      ...
                      className={`
                        ...
                        ${displayConnected ? 'bg-green-500 text-black' : 'bg-[#FF5D00] text-black hover:bg-[#FF7A33]'}
                      `}
                    >
                      {displayConnected ? (
                        <>
