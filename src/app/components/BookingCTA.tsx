    ...
    <section id="booking-cta" className="relative py-32 overflow-hidden bg-black">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <span className="text-sm font-bold text-[#FF5D00] tracking-wider uppercase">No Sales Calls. Just Results.</span>
          </motion.div>
          ...
          >
            Skip the <span className="text-white/20 line-through decoration-[#FF5D00]/50 decoration-4">sales script.</span> <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF5D00] to-[#FF9D00]">Talk to Maja.</span>
          </motion.h2>
          ...
          >
            Try Maja for free and start the conversation instantly.
          </motion.p>
          ...
          >
            <div className="flex items-center gap-2 text-white/30 text-sm uppercase tracking-widest font-semibold">
              <span>Open the widget in the corner</span>
        ...
        >
          <div className="bg-white text-black px-6 py-4 rounded-2xl rounded-br-sm shadow-[0_8px_30px_rgb(0,0,0,0.2)] flex items-center gap-4 relative group hover:scale-105 transition-transform">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-black/60 font-medium">We reply instantly</span>
            </div>
            <div className="relative flex h-3 w-3">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#00C455] opacity-75" />
              <span className="relative inline-flex rounded-full h-3 w-3 bg-[#00C455]" />
            </div>
          </div>
        </motion.div>
      )}
