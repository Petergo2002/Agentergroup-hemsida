        ...
        >
            ...
            <div className="glass rounded-3xl p-8 md:p-10 shadow-2xl shadow-brand-500/5 relative overflow-hidden">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <blockquote className="text-xl md:text-2xl leading-relaxed text-center font-medium">
                    "{t.text}"
                  </blockquote>

                  <div className="mt-8 flex flex-col items-center">
                    <div className="h-16 w-16 rounded-full overflow-hidden border-2 border-brand-400/30 mb-3">
                      <img 
                        src={t.avatar} 
                        alt={t.name}
          ...
          <div className="mt-10 text-center">
            <p className="text-white/60 text-sm">
              Vill du dela din upplevelse? <a href="#offert" className="text-brand-300 hover:text-white transition-colors">Kontakta oss</a>
            </p>
          </div>
        </div>
      </div>
