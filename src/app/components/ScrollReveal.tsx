...
export default function ScrollReveal() {
    ...
    return (
        <section ref={containerRef} className="h-[200vh] relative bg-[#050505] font-sans">
            <div className="sticky top-0 h-screen flex flex-col items-center justify-center overflow-hidden">

                {/* Very Subtle Background Glow - Barely visible to keep it clean */}
                <div className="absolute inset-0 pointer-events-none">
                    <motion.div
                        style={{ opacity: useTransform(smoothProgress, [0, 0.5, 1], [0, 0.05, 0]) }}
                        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[60vw] h-[60vw] bg-[#FF5D00] rounded-full blur-[100px] translate-z-0 will-change-transform"
                    />
                </div>
