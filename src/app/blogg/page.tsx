        ...
        <div className="container grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <article className="group glass rounded-2xl p-6 hover:bg-white/15 transition-colors border border-white/10">
            ...
            <h2 className="mt-3 text-xl font-semibold group-hover:text-white">
              <Link href="/blogg/ai-receptionist-for-fastighetsforvaltning">
                AI-receptionist för fastighetsförvaltning: Automatisera felanmälan
              </Link>
            </h2>
            <p className="mt-2 text-white/70">
              Sänk era jourkostnader och öka servicen för hyresgästerna. En AI-receptionist hanterar felanmälan och frågor dygnet runt.
            </p>
            <div className="mt-4">
              <Link href="/blogg/ai-receptionist-for-fastighetsforvaltning" className="btn btn-secondary">
                Läs artikeln
              </Link>
            </div>
          </article>
