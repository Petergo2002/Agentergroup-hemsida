    ...
    <main>
      ...
      <section className="section">
        <div className="container grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Article: Svarservice vs AI-receptionist */}
          <article className="group glass rounded-2xl p-6 hover:bg-white/15 transition-colors border border-white/10">
            ...
            <h2 className="mt-3 text-xl font-semibold group-hover:text-white">
              <Link href="/blogg/svarservice-vs-ai-receptionist">
                Svarservice vs AI-receptionist
              </Link>
            </h2>
            <p className="mt-2 text-white/70">
              Vad är bäst för ditt företag? Vi jämför kostnad, svarstider och funktioner.
            </p>
            <div className="mt-4">
              <Link href="/blogg/svarservice-vs-ai-receptionist" className="btn btn-secondary">
                Läs artikeln
              </Link>
            </div>
          </article>
