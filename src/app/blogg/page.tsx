    ...
    <main>
      ...
      <section className="section">
        <div className="container grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Article: Telefonpassning för kliniker */}
          <article className="group glass rounded-2xl p-6 hover:bg-white/15 transition-colors border border-white/10">
            ...
            <h2 className="mt-3 text-xl font-semibold group-hover:text-white">
              <Link href="/blogg/telefonpassning-for-kliniker">
                Telefonpassning för kliniker: Så ökar ni beläggningen med AI
              </Link>
            </h2>
            <p className="mt-2 text-white/70">
              Driver du klinik? Missade samtal är förlorade patienter. Lär dig hur en AI-receptionist sköter bokningar dygnet runt.
            </p>
            <div className="mt-4">
              <Link href="/blogg/telefonpassning-for-kliniker" className="btn btn-secondary">
                Läs artikeln
              </Link>
            </div>
          </article>
